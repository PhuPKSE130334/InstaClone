...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let newPostVC = newPostStoryboard.instantiateViewController(withIdentifier: "newPostViewController") as! NewPostViewController

        let activityVC = activityStoryboard.instantiateViewController(withIdentifier: "activityViewController") as! ActivityViewController
